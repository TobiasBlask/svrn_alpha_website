...
window.renderShell = function(active, crumbs) {
  const nav = [
    { key: 'today',   label: 'Heute',          href: 'today.html' },
    { key: 'signals', label: 'Signale',        href: 'market-detail.html', count: 14 },
    { key: 'ideas',   label: 'Top-Ideen',      href: 'top-ideas.html' },
    { key: 'desk',    label: 'Das Desk',       href: 'desk.html', dot: true },
    { key: 'screener',label: 'Screener',       href: 'screener.html' },
    { key: 'analysts',label: 'Analysten',      href: 'analysts.html' },
    { key: 'packages',label: 'Pakete',         href: 'packages.html' },
    { key: 'brief',   label: 'Morgen-Briefing',href: 'brief.html' },
    { key: 'alerts',  label: 'Meldungen',      href: '#', count: 3 }
  ];
  ...
  if (side) side.innerHTML = `
    ...
    <div class="app__nav-group">
      <div class="app__nav-label eyebrow">Arbeitsbereich</div>
      ${nav.map(n => `
    ...
    <div class="app__nav-group">
      <div class="app__nav-label eyebrow">Beobachtungsliste</div>
      ...
      <a class="app__nav-item app__nav-item--sub app__nav-item--muted">+ 10 weitere</a>
    </div>
  ...
  if (top) top.innerHTML = `
    ...
    <div class="app__search">
      ...
      <input placeholder="Märkte, Berichte, Analysten, Portfolios durchsuchen…" />
      <span class="kbd mono">⌘K</span>
    </div>
    <div class="app__top-right">
      <button class="btn btn--sm btn--ghost" title="Meldungen">
      ...
      <button class="btn btn--sm">Teilen</button>
      <a class="btn btn--sm btn--ghost" href="../Premise Phase 2.html">← Alle Screens</a>
    </div>`;
};
